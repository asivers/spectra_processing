...
ax.plot(energyNp, lorentz4, label='Неизв. пик')
ax.plot(energyNp, lorentz5, label='D3')
ax.plot(energyNp, lorentz6, label='D4')
ax.plot(energyNp, lorentz7, label='Неизв. пик')
ax.plot(energyNp, lorentz8, label='Краевая')
